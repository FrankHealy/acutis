...
import { Users, UserPlus, ClipboardList, MapPin, LogOut } from 'lucide-react-native';
      ...
      <ScrollView contentContainerStyle={{ padding: 16 }}>
        ...
        <View style={styles.actionsGrid}>
          ...
          <Pressable android_ripple={{ color: '#e5e7eb' }} style={styles.actionCard} onPress={() => navigation.navigate('GroupTherapy')}>
            ...
            <Text style={styles.actionSub}>Start a session</Text>
          </Pressable>
          <Pressable android_ripple={{ color: '#e5e7eb' }} style={styles.actionCard} onPress={() => navigation.navigate('RoomMap')}>
            <MapPin color="#0f172a" size={18} />
            <Text style={styles.actionTitle}>Room Map</Text>
            <Text style={styles.actionSub}>View room assignments</Text>
          </Pressable>
        </View>
      </ScrollView>
    </View>
