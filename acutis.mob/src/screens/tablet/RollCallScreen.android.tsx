...
export default function RollCallScreen({ navigation }: any) {
  return (
      ...
      <ScrollView contentContainerStyle={{ padding: 16 }}>
        <View style={styles.card}>
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 }}>
            <ClipboardList color={theme.colors.text.primary} size={18} />
            <Text style={styles.cardTitle}>Detox Unit</Text>
          </View>
          <Text style={styles.cardText}>Placeholder list of residents to mark present/absent.</Text>
        </View>

        <View style={styles.card}>
          <Text style={styles.cardTitle}>Alcohol Unit</Text>
          <Text style={styles.cardText}>Placeholder list of residents to mark present/absent.</Text>
        </View>
      </ScrollView>
    </View>
