...
import { Users, ChevronLeft, ArrowRight } from 'lucide-react-native';
import { theme } from '../../theme';

export default function GroupTherapyScreen({ navigation }: any) {
  return (
    <View style={styles.root}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Group Therapy</Text>
        <View style={{ width: 22 }} />
      </View>
      ...
      <ScrollView contentContainerStyle={{ padding: 16 }}>
        <Pressable
          ...
          onPress={() => navigation.navigate('GroupTherapySession')}
          style={styles.card}
        >
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 }}>
            <Users color={theme.colors.text.primary} size={18} />
            <Text style={styles.cardTitle}>Sessions</Text>
          </View>
          <Text style={styles.cardText}>Step 1: Powerlessness • Morning Session • 1/20/2026</Text>
          <View style={styles.cardFooter}>
            <Text style={styles.cardAction}>Open session</Text>
            <ArrowRight color={theme.colors.text.primary} size={16} />
          </View>
        </Pressable>
      </ScrollView>
    </View>
...
const styles = StyleSheet.create({
  ...
  cardAction: { color: theme.colors.text.primary, fontWeight: '700' },
});
