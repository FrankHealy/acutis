...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CallLog>(e =>
        {
            ...
            e.Property(x => x.CallerType).HasMaxLength(64).IsRequired();
            e.Property(x => x.ConcernType).HasMaxLength(64).IsRequired();
            e.Property(x => x.Unit).HasMaxLength(64).IsRequired();
            e.Property(x => x.Location).HasMaxLength(128).IsRequired();
            e.Property(x => x.PhoneNumber).HasMaxLength(64).IsRequired();
            ...
            e.Property(x => x.Urgency).HasMaxLength(64).IsRequired();
        ...
        {
            e.ToTable("AuditEntries", schema: "Audit");
            e.HasKey(x => x.Id);
            e.Property(x => x.EntityName).HasMaxLength(128).IsRequired();
            e.Property(x => x.Action).HasMaxLength(32).IsRequired();
            e.Property(x => x.KeyValues).HasColumnType("nvarchar(max)");
            e.Property(x => x.OriginalValues).HasColumnType("nvarchar(max)");
            e.Property(x => x.CurrentValues).HasColumnType("nvarchar(max)");
            e.Property(x => x.ChangedColumns).HasColumnType("nvarchar(max)");
