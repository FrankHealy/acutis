...
{
    /// <inheritdoc />
    public partial class AddScheduledIntakeBoard : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScheduledIntake", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScheduledIntake_ResidentCase_ResidentCaseId",
                        column: x => x.ResidentCaseId,
                        principalTable: "ResidentCase",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScheduledIntake_Unit_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Unit",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduledIntake_ResidentCaseId",
                table: "ScheduledIntake",
                column: "ResidentCaseId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ScheduledIntake_UnitId_ScheduledDate_Status",
                table: "ScheduledIntake",
                columns: new[] { "UnitId", "ScheduledDate", "Status" });
        }
