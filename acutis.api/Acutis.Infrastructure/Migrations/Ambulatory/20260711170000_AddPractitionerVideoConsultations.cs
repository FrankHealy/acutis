    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                RoomName = table.Column<string>(type: "nvarchar(96)", maxLength: 96, nullable: false),
        ...
        migrationBuilder.CreateIndex(
            name: "IX_VideoConsultationInvitation_VideoConsultationId_ExpiresAtUtc",
            table: "VideoConsultationInvitation",
            columns: new[] { "VideoConsultationId", "ExpiresAtUtc" });
    }

    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.DropTable(name: "VideoConsultationInvitation");
        migrationBuilder.DropTable(name: "VideoConsultation");
    }
}
