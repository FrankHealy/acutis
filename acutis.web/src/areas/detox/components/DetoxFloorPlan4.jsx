  ...
  return (
    <div style={{ overflow: 'auto', background: '#9a9a9a', padding: 20, minHeight: '100vh' }}>
      ...
      <div style={{
        ...
        <Rect x={905} y={8} w={20} h={49} bg="#D9D9D9" border="none" />
        ...
        {[
          ...
          return (
            <React.Fragment key={i}>
              {/* White gap over room right border */}
              <div style={{
                position: 'absolute',
                left: s(971), top: s(doorY),
                width: s(8), height: s(doorH),
                background: '#D9D9D9',
                zIndex: 3,
              }} />
              {/* Top jamb */}
              <div style={{
                position: 'absolute',
                left: s(968), top: s(doorY - 3),
                width: s(14), height: s(3),
                background: '#111', zIndex: 3,
              }} />
              {/* Bottom jamb */}
              <div style={{
                position: 'absolute',
                left: s(968), top: s(doorY + doorH),
                width: s(14), height: s(3),
                background: '#111', zIndex: 3,
              }} />
            </React.Fragment>
        ...
        {/* Fill white gap left of SA2 with corridor grey */}
        ...
        {[0.5, 78.5, 156.5, 234.5, 305.5].map((x, i) => {
          ...
          return (
            <React.Fragment key={i}>
              {/* White gap over room top border */}
              <div style={{
                position: 'absolute',
                left: s(doorX), top: s(687),
                width: s(doorW), height: s(8),
                background: '#D9D9D9',
                zIndex: 3,
              }} />
              {/* Left jamb */}
              <div style={{
                position: 'absolute',
                left: s(doorX - 3), top: s(684),
                width: s(3), height: s(14),
                background: '#111', zIndex: 3,
              }} />
              {/* Right jamb */}
              <div style={{
                position: 'absolute',
                left: s(doorX + doorW), top: s(684),
                width: s(3), height: s(14),
                background: '#111', zIndex: 3,
              }} />
            </React.Fragment>
        ...
        <Room x={459.5} y={816.5} w={147} h={241} label={LABELS.common} />
        ...
        {(() => { const x=607.5, w=148, doorW=20, doorX=x+Math.round((w-doorW)/2); return (
          <React.Fragment>
            <div style={{ position:'absolute', left:s(doorX), top:s(687), width:s(doorW), height:s(8), background:'#D9D9D9', zIndex:3 }} />
            <div style={{ position:'absolute', left:s(doorX-3), top:s(684), width:s(3), height:s(14), background:'#111', zIndex:3 }} />
            <div style={{ position:'absolute', left:s(doorX+doorW), top:s(684), width:s(3), height:s(14), background:'#111', zIndex:3 }} />
          </React.Fragment>
        ); })()}
        {/* RM4 and RM6 */}
        ...
        {(() => { const x=967.5, w=77, doorW=20, doorX=x+Math.round((w-doorW)/2); return (
          <React.Fragment>
            <div style={{ position:'absolute', left:s(doorX), top:s(686), width:s(doorW), height:s(8), background:'#D9D9D9', zIndex:3 }} />
            <div style={{ position:'absolute', left:s(doorX-3), top:s(683), width:s(3), height:s(14), background:'#111', zIndex:3 }} />
            <div style={{ position:'absolute', left:s(doorX+doorW), top:s(683), width:s(3), height:s(14), background:'#111', zIndex:3 }} />
          </React.Fragment>
        ); })()}
        ...
        <Room x={305.5} y={812} w={77} h={68} label="" />
        ...
        <Rect x={78} y={556} w={61} h={62} bg="#D9D9D9" border="none" style={{ zIndex: 0 }} />
