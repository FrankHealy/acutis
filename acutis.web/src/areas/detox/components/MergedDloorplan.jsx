...
const MAINHOUSE_CROP_TOP = 56;
const MAINHOUSE_VIEW_WIDTH = 930;
const MAINHOUSE_VIEW_HEIGHT = 900;
const MAINHOUSE_COMPONENT_SCALE_X = 1.62;
const MAINHOUSE_COMPONENT_SCALE_Y = 0.96;
const DETOX_STAGE_WIDTH = 1248;
const DETOX_STAGE_HEIGHT = 1092;
const DETOX_CROP_LEFT = 150;
const DETOX_CROP_TOP = 60;
...
const MAINHOUSE_OFFSET_Y = -48;
const DETOX_OFFSET_X = 1217;
const DETOX_OFFSET_Y = 360;
